...
class FruitController extends Controller
{
    ...
    {
        // dd($request->all()); //buah liat ini datanya masuk ato enggakk di webnya
        $pesan=[
            'nama_buah.required' => 'Nama Buah kosong, Isi Terlebih Dahulu!',
            'harga.required' => 'Harga kosong, Isi Terlebih Dahulu!',
